...
var favoriteFlavorsOfIceCream = ["Joe": "Peanut Butter and Chocolate", "Tim": "Natural Vanilla", "Sophie": "Mexican Chocolate", "Deniz": "Natural Vanilla", "Tom": "Mexican Chocolate", "Jim": "Natural Vanilla", "Mark": "Cookies 'N' Cream"]
/*: directions2
...
func namesForIceCreamFlavor(flavor: String) -> [String] {
  ...
  //  switch flavor {
    //    case "Peanut Butter and Chocolate":
      //      return ["Joe"]
        //case "Natural Vanilla":
          //  return ["Tim", "Deniz", "Jim"]
//        case "Mexican Chocolate":
  //          return ["Sophie", "Tom"]
...
func iceCreamForPerson(name: String) -> String? {
    if let favorite = favoriteFlavorsOfIceCream[name] {
        return favorite
    } else {
        return nil
    }
...
func replaceFlavor(flavor: String, forPerson person: String) -> Bool {
    if favoriteFlavorsOfIceCream[person] == nil {
        ...
        return false
    } else if favoriteFlavorsOfIceCream[person] != nil {
        //print((namesForIceCreamFlavor(oldFlavor)).count)
        //print(oldFlavor)
        favoriteFlavorsOfIceCream[person] = nil
        
        //print(favoriteFlavorsOfIceCream[person])
